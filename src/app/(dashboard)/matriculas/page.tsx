  ...
  return (
    <div className="space-y-6 flex flex-col h-[80vh]">
      ...
      <div className="pb-4 border-b border-border">
        ...
        <p className="text-muted-foreground text-sm mt-1">Gestão de novas matrículas e renovações.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-border rounded-2xl bg-card/50 p-6">
        ...
        <h3 className="text-xl font-bold text-foreground mb-2 text-center">Matrícula de Novo Aluno</h3>
        ...
        <Button 
          ...
          className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold gap-2 px-6 py-5 rounded-2xl cursor-pointer shadow-lg hover:shadow-xl transition-all duration-200 border-none text-base disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        {!podeRealizarMatricula ? (
          <div className="mt-6 p-4 rounded-xl border border-destructive/20 bg-destructive/10 text-destructive text-xs text-center max-w-sm flex flex-col items-center gap-1.5 font-medium">
