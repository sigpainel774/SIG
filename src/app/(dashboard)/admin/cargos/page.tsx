  ...
  return (
    <div className="space-y-6">
      <div className="pb-4 border-b border-[#3f3f46]">
        ...
        <p className="text-[#aaa] text-sm mt-1">Gestão de salários, funções oficiais e níveis ABAC.</p>
      </div>
      <div className="flex flex-col items-center justify-center p-12 border border-dashed border-[#3f3f46] rounded-xl bg-[#121212]/50">
        <Briefcase className="w-16 h-16 text-[#3f3f46] mb-4" />
        <h3 className="text-xl font-bold text-white mb-2">Em Construção</h3>
        <p className="text-[#aaa] text-center max-w-md">O dicionário de cargos municipais está sendo integrado ao Supabase.</p>
      </div>
    </div>
  )
}
