    ...
    <div className="min-h-screen bg-[#0f0f11] flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2">
          <div className="w-14 h-14 bg-indigo-600/10 border border-indigo-500/30 text-indigo-400 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-indigo-600/20">
        ...
        <div className="bg-[#141416] border border-[#27272a] rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="pl-9 bg-[#18181b] border-[#27272a] text-sm text-foreground focus:border-indigo-500"
                />
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-[#27272a]/60 text-center space-y-2">
