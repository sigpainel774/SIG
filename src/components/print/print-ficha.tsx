...
export function PrintFicha({
  ...
  return (
    <div className="print-portal-container p-6 bg-white text-black max-w-3xl mx-auto rounded-xl border border-gray-300 shadow-sm print:shadow-none print:border-none print:p-0 print:max-w-none print:w-full">
      <style>{`
        @media print {
          @page {
            size: A4 portrait;
