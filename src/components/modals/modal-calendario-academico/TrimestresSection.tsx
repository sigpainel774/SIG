  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="bg-[#18181b] border border-border/60 rounded-xl p-3 flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* 1º Trimestre */}
        <div className="bg-[#141416] border border-[#27272a] rounded-xl p-3.5 space-y-3 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="bg-[#141416]/90 border border-[#27272a] rounded-xl p-3 space-y-2">
