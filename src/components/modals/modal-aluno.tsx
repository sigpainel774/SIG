...
export function ModalAluno({ open, onOpenChange, trigger, alunoEditar, onSuccess }: ModalAlunoProps) {
  ...
  return (
    <Dialog open={activeOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-[860px] w-[90vw] max-h-[88vh] bg-[#181818] border border-[#2a2a2a] text-[#f1f1f1] p-0 overflow-hidden flex flex-col rounded-xl shadow-2xl">
