  ...
  return (
    <section className="overflow-hidden border border-[#26262a] rounded-2xl bg-gradient-to-b from-[#1a202c]/95 to-[#121621]/95 shadow-xl">
      ...
      <div className="p-4 md:p-5 space-y-5">
            ...
            <div className="absolute z-20 left-0 right-0 mt-1 bg-[#121621] border border-[#26262a] rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto divide-y divide-[#26262a]">
              {alunosEncontrados.map((a) => (
                <button
                  ...
                  className="w-full px-4 py-2.5 text-left flex items-center justify-between hover:bg-[#3ea6ff]/10 transition-all text-xs"
                >
                  <div className="flex items-center gap-2.5">
                    <User className="w-4 h-4 text-[#3ea6ff]" />
                    <div>
                  ...
                  <span className="text-[#3ea6ff] font-semibold text-[11px]">Selecionar</span>
                </button>
              ))}
            </div>
          )}
        ...
        {alunoSelecionado && (
          <div className="flex items-center gap-3 p-3 border border-[#3ea6ff]/30 rounded-xl bg-[#3ea6ff]/10">
            <CheckCircle2 className="w-5 h-5 text-[#3ea6ff] flex-shrink-0" />
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[11px] font-extrabold text-[#3ea6ff] uppercase tracking-wider">Identificação</span>
            <div className="h-[1px] flex-1 bg-[#26262a]"></div>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[11px] font-extrabold text-[#3ea6ff] uppercase tracking-wider">Família e contato</span>
            <div className="h-[1px] flex-1 bg-[#26262a]"></div>
          </div>
