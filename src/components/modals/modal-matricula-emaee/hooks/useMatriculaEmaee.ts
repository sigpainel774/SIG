      ...
      if (isEditMode && props.matriculaEditar?.id) {
        ...
        for (const vinc of existentesParaAtualizar) {
          ...
          const updatePayload: any = {
            ...
            data_inicio: isFila ? null : (vinc.dataInicio || dataMatricula || getHojeBrasilia()),
        ...
        const novosParaInserir = vinculosAEE
          ...
          .map(v => {
            ...
            return {
              ...
              data_solicitacao: v.dataSolicitacao || dataMatricula || getHojeBrasilia(),
              ...
              data_inicio: isFila ? null : (v.dataInicio || dataMatricula || getHojeBrasilia()),
