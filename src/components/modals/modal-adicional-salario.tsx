...
export function ModalAdicionalSalario({ open, onOpenChange, funcionarioId, funcionarioNome }: ModalAdicionalSalarioProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] bg-[#121214] border-[#27272a] text-white">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold flex items-center gap-2 text-white">
            <Coins className="w-5 h-5 text-yellow-500" />
            Adicionais de Salário — {funcionarioNome ?? 'Funcionário'}
          </DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter className="pt-4 border-t border-[#27272a]">
          <Button
            type="button"
            variant="outline"
